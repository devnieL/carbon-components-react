...
var _2 = _interopRequireDefault(require("@carbon/icons-react/lib/chevron--down/16"));

var _FeatureFlags = require("../../internal/FeatureFlags");

var _Icon = _interopRequireDefault(require("../Icon"));

var _key4 = require("../../tools/key");
...
function (_Component2) {
  ...
  function ClickableTile() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleKeyDown", function (evt) {
      if ((0, _key4.matches)(evt, [_key4.keys.ENTER, _key4.keys.SPACE])) {
        _this.setState({
          clicked: !_this.state.clicked
        }, function () {
  ...
  _createClass(ExpandableTile, [{
    ...
    value: function render() {
      ...
      return (// eslint-disable-next-line jsx-a11y/click-events-have-key-events,jsx-a11y/no-static-element-interactions
        ...
        }, _FeatureFlags.componentsX ? _react.default.createElement(_2.default, {

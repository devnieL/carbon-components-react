...
function (_Component) {
  ...
  _createClass(TimePickerSelect, [{
    ...
    value: function render() {
      ...
      var selectClasses = (0, _classnames.default)((_classNames = {}, _defineProperty(_classNames, "".concat(prefix, "--select"), true), _defineProperty(_classNames, "".concat(prefix, "--time-picker__select"), true), _defineProperty(_classNames, "".concat(prefix, "--select--inline"), !_FeatureFlags.componentsX), _defineProperty(_classNames, className, className), _classNames));
